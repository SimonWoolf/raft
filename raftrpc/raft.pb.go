...
type ClientLogAppendResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Response string `protobuf:"bytes,1,opt,name=response,proto3" json:"response,omitempty"`
	Error    string `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"` // Errors other than responses from the application state machine
}

func (x *ClientLogAppendResponse) Reset() {
	*x = ClientLogAppendResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ClientLogAppendResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientLogAppendResponse) ProtoMessage() {}

func (x *ClientLogAppendResponse) ProtoReflect() protoreflect.Message {
	mi := &file_raftrpc_raft_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientLogAppendResponse.ProtoReflect.Descriptor instead.
func (*ClientLogAppendResponse) Descriptor() ([]byte, []int) {
	return file_raftrpc_raft_proto_rawDescGZIP(), []int{2}
}

func (x *ClientLogAppendResponse) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
func (x *ClientLogAppendResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *AppendEntriesResponse) GetResult() bool {
	if x != nil {
		return x.Result
	}
	return false
...
var file_raftrpc_raft_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x22, 0x4b, 0x0a, 0x17, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x4c, 0x6f, 0x67, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x72, 0x6f, 0x72, 0x22, 0xc9, 0x01, 0x0a, 0x14, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x45, 0x6e,
	...
	0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72, 0x65, 0x76, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x72, 0x65, 0x76, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1a,
	0x0a, 0x08, 0x70, 0x72, 0x65, 0x76, 0x54, 0x65, 0x72, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x08, 0x70, 0x72, 0x65, 0x76, 0x54, 0x65, 0x72, 0x6d, 0x12, 0x23, 0x0a, 0x07, 0x65, 0x6e,
	0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x4c, 0x6f,
	...
	0x05, 0x52, 0x08, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x6c,
	...
	0x43, 0x0a, 0x15, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73,
	...
	0x74, 0x65, 0x72, 0x6d, 0x32, 0x8c, 0x01, 0x0a, 0x04, 0x52, 0x61, 0x66, 0x74, 0x12, 0x3e, 0x0a,
	...
	0x0f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64,
	0x12, 0x17, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x41, 0x70, 0x70, 0x65,
	0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x4c, 0x6f, 0x67, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_raftrpc_raft_proto_goTypes = []interface{}{
	...
	(*ClientLogAppendResponse)(nil), // 2: ClientLogAppendResponse
...
var file_raftrpc_raft_proto_depIdxs = []int32{
	...
	4, // 3: Raft.AppendEntries:output_type -> AppendEntriesResponse
	2, // 4: Raft.ClientLogAppend:output_type -> ClientLogAppendResponse
...
func file_raftrpc_raft_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_raftrpc_raft_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClientLogAppendResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
